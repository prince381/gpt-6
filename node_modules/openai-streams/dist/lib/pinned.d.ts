...
export interface CreateAnswerRequest {
    /**
       ...
       * @type {string} @memberof CreateAnswerRequest
       */
    "model": string;
    /**
    ...
    /**
       ...
       * the tone and answer format you\'d like. We recommend adding 2 to 3
       * examples.
       * @type {Array<any>} @memberof CreateAnswerRequest
       */
    "examples": Array<any>;
    /**
    ...
    /**
       ...
       * be derived. If this is an empty list, the question will be answered based
       * on the question-answer examples.  You should specify either `documents`
       * or a `file`, but not both.
       * @type {Array<string>} @memberof CreateAnswerRequest
       */
    "documents"?: Array<string> | null;
    /**
       * The ID of an uploaded file that contains documents to search over. See
       * [upload file](/docs/api-reference/files/upload) for how to upload a file
       * of the desired format and purpose.  You should specify either `documents`
       * or a `file`, but not both.
       * @type {string} @memberof CreateAnswerRequest
       */
    "file"?: string | null;
    ...
    /**
       ...
       * [Search](/docs/api-reference/searches/create) when using `file`. Setting
       * it to a higher value leads to improved accuracy but with increased
       * latency and cost.
       * @type {number} @memberof CreateAnswerRequest
       */
    ...
    /**
       ...
       * (argmax sampling) works better for scenarios with a well-defined answer.
       * @type {number} @memberof CreateAnswerRequest
       */
    "temperature"?: number | null;
    /**
       ...
       * center](https://help.openai.com) and describe your use case.  When
    ...
    /**
       ...
       * use this [tokenizer tool](/tokenizer?view=bpe) (which works for both
       ...
       * an example, you can pass `{\"50256\": -100}` to prevent the <|endoftext|>
       * token from being generated.
       * @type {object} @memberof CreateAnswerRequest
       */
    "logit_bias"?: object | null;
    /**
       ...
       * @type {boolean} @memberof CreateAnswerRequest
       */
    ...
    /**
       ...
       * more](/docs/usage-policies/end-user-ids).
       * @type {string} @memberof CreateAnswerRequest
       */
    "user"?: string;
}
/**
 * @type CreateAnswerRequestStop Up to 4 sequences where the API will stop
...
export interface CreateClassificationRequest {
    /**
       ...
       * models, or see our [Model overview](/docs/models/overview) for
       * descriptions of them.
       * @type {string} @memberof CreateClassificationRequest
       */
    "model": string;
    /**
    ...
    "query": string;
    /**
       * A list of examples with labels, in the following format:  `[[\"The movie
       * is so interesting.\", \"Positive\"], [\"It is quite boring.\",
       * \"Negative\"], ...]`  All the label strings will be normalized to be
       * capitalized.  You should specify either `examples` or `file`, but not
       * both.
       * @type {Array<any>} @memberof CreateClassificationRequest
       */
    "examples"?: Array<any> | null;
    /**
       * The ID of the uploaded file that contains training examples. See [upload
       * file](/docs/api-reference/files/upload) for how to upload a file of the
       * desired format and purpose.  You should specify either `examples` or
       * `file`, but not both.
       * @type {string} @memberof CreateClassificationRequest
       */
    "file"?: string | null;
    /**
       * The set of categories being classified. If not specified, candidate
       ...
       * @type {Array<string>} @memberof CreateClassificationRequest
       */
    ...
    /**
       ...
       * @type {number} @memberof CreateClassificationRequest
       */
    "temperature"?: number | null;
    /**
       * Include the log probabilities on the `logprobs` most likely tokens, as
    ...
    /**
       ...
       * an example, you can pass `{\"50256\": -100}` to prevent the <|endoftext|>
       * token from being generated.
       * @type {object} @memberof CreateClassificationRequest
       */
    "logit_bias"?: object | null;
    /**
       * If set to `true`, the returned JSON will include a \"prompt\" field
       * containing the final prompt that was used to request a completion. This
       * is mainly useful for debugging purposes.
       * @type {boolean} @memberof CreateClassificationRequest
       */
    "return_prompt"?: boolean | null;
    /**
       * A special boolean flag for showing metadata. If set to `true`, each
...
export interface CreateCompletionRequest {
    /**
       ...
       * models, or see our [Model overview](/docs/models/overview) for
       * descriptions of them.
       * @type {string} @memberof CreateCompletionRequest
       */
    "model": string;
    /**
       *
    ...
    /**
       ...
       * @type {number} @memberof CreateCompletionRequest
       */
    "max_tokens"?: number | null;
    /**
       * What [sampling
       ...
       * well-defined answer.  We generally recommend altering this or `top_p` but
       * not both.
       * @type {number} @memberof CreateCompletionRequest
       */
    "temperature"?: number | null;
    ...
    /**
       ...
       * message.
       * @type {boolean} @memberof CreateCompletionRequest
       */
    "stream"?: boolean | null;
    /**
       * Include the log probabilities on the `logprobs` most likely tokens, as
    ...
    /**
       ...
       * likelihood to talk about new topics.  [See more information about
       * frequency and presence penalties.](/docs/api-reference/parameter-details)
       * @type {number} @memberof CreateCompletionRequest
       */
    "presence_penalty"?: number | null;
    /**
    ...
    /**
       ...
       * greater than `n`.  **Note:** Because this parameter generates many
    ...
    /**
       ...
       * an example, you can pass `{\"50256\": -100}` to prevent the <|endoftext|>
       * token from being generated.
       * @type {object} @memberof CreateCompletionRequest
       */
    "logit_bias"?: object | null;
    /**
       * A unique identifier representing your end-user, which will help OpenAI to
...
/**
 * @type CreateCompletionRequestPrompt The prompt(s) to generate completions
 * for, encoded as a string, array of strings, array of tokens, or array of
 * token arrays.  Note that <|endoftext|> is the document separator that the
 * model sees during training, so if a prompt is not specified the model will
...
/**
 * @type CreateCompletionRequestStop Up to 4 sequences where the API will stop
 * generating further tokens. The returned text will not contain the stop
 * sequence.
 * @export
 */
...
export interface CreateEditRequest {
    /**
       ...
       * models, or see our [Model overview](/docs/models/overview) for
       * descriptions of them.
       * @type {string} @memberof CreateEditRequest
       */
    "model": string;
    /**
    ...
    /**
       ...
       * @type {number} @memberof CreateEditRequest
       */
    "n"?: number | null;
    /**
       * What [sampling
...
export interface CreateEmbeddingRequest {
    /**
       ...
       * models, or see our [Model overview](/docs/models/overview) for
       * descriptions of them.
       * @type {string} @memberof CreateEmbeddingRequest
       */
    "model": string;
    /**
       *
...
/**
 * @type CreateEmbeddingRequestInput Input text to get embeddings for, encoded
 * as a string or array of tokens. To get embeddings for multiple inputs in a
 * single request, pass an array of strings or array of token arrays. Each input
 * must not exceed 2048 tokens in length.  Unless you are embedding code, we
...
export interface CreateFineTuneRequest {
    /**
       ...
       * file](/docs/api-reference/files/upload) for how to upload a file.  Your
       ...
       * you must upload your file with the purpose `fine-tune`.  See the
       * [fine-tuning guide](/docs/guides/fine-tuning/creating-training-data) for
       * more details.
    ...
    /**
       ...
       * 2022-04-21. To learn more about these models, see the
    ...
    /**
       ...
       * @type {number} @memberof CreateFineTuneRequest
       */
    ...
    /**
       ...
       * number of examples in the training set, capped at 256 - in general,
    ...
    /**
       ...
       * the 0.05, 0.1, or 0.2 depending on final `batch_size` (larger learning
    ...
    /**
       ...
       * file](/docs/guides/fine-tuning/analyzing-your-fine-tuned-model).  In
       ...
       * @type {boolean} @memberof CreateFineTuneRequest
       */
...
export interface CreateImageRequest {
    /**
       ...
       * characters.
       * @type {string} @memberof CreateImageRequest
       */
    "prompt": string;
    /**
       * The number of images to generate. Must be between 1 and 10.
       * @type {number} @memberof CreateImageRequest
       */
    "n"?: number | null;
    /**
...
export interface CreateModerationRequest {
    ...
    /**
       ...
       * and `text-moderation-latest`.  The default is `text-moderation-latest`
       * which will be automatically upgraded over time. This ensures you are
       * always using our most accurate model. If you use
       * `text-moderation-stable`, we will provide advanced notice before updating
       * the model. Accuracy of `text-moderation-stable` may be slightly lower
       * than for `text-moderation-latest`.
       * @type {string} @memberof CreateModerationRequest
       */
    "model"?: string;
}
/**
...
export interface CreateSearchRequest {
    /**
       ...
       * @type {string} @memberof CreateSearchRequest
       */
    "query": string;
    /**
       * Up to 200 documents to search over, provided as a list of strings.  The
       * maximum document length (in tokens) is 2034 minus the number of tokens in
       * the query.  You should specify either `documents` or a `file`, but not
       * both.
       * @type {Array<string>} @memberof CreateSearchRequest
       */
    "documents"?: Array<string> | null;
    /**
       * The ID of an uploaded file that contains documents to search over.  You
    ...
    /**
       ...
       * This flag only takes effect when `file` is set.
       * @type {number} @memberof CreateSearchRequest
       */
    "max_rerank"?: number | null;
    /**
       * A special boolean flag for showing metadata. If set to `true`, each
       * document entry in the returned JSON will contain a \"metadata\" field.
       * This flag only takes effect when `file` is set.
       * @type {boolean} @memberof CreateSearchRequest
       */
    "return_metadata"?: boolean | null;
    /**
       * A unique identifier representing your end-user, which will help OpenAI to
